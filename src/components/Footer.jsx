...
import LogoColorVersion2 from '/Logo_Color_Version_2.svg';
...
export const Footer = () => {
  return (
    <footer>
      <div className="pt-10 lg:pt-20 lg:pb-12 bg-customTercery items-center justify-center">
        <div className="container mx-auto px-4 w-4/5 md:w-11/12 lg:w-10/12 xl:w-4/5 2xl:w-2/3">
          <div className="flex flex-wrap">
            <div className="w-full lg:w-1/3 mb-16 lg:mb-0">
              ...
              {/* <div className="w-36 mx-auto lg:mx-0">
                <a
                  className="inline-block w-10  h-10 mr-2 p-2 bg-customDarkBg2 custom-border-gray  hover:bg-customNobuGreen rounded-xl"
                  href="#"
                >
                  <FacebookIcon />
                </a>
          ...
          <p className="lg:text-center text-sm text-white border-t border-white pt-12 mt-16 hidden lg:block">
