...
export const Espacios = () => {
  return (
    <section
      className="w-full bg-customGray py-32 sm:py-32 md:py-32 lg:py-32 px-4 sm:px-6 lg:px-16 relative overflow-hidden"
      id="espacios"
    >
      <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-between w-full max-w-7xl mx-auto gap-8 lg:gap-12">
          <div className="w-full lg:w-2/5 mb-8 lg:mb-0 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="text-customNobuColor mb-6 leading-relaxed text-justify sm:text-center lg:text-left max-w-xl">
          ...
          <div className="hidden md:block absolute right-0 w-96 h-96 bg-customNobuColor opacity-50 rotate-45  translate-x-48 translate-y-48"></div>
