...
export { heroBackground, servicesBackground, bookingBackground } from "./backgrounds";
export type { ServiceSliceConfig, ServiceHeroConfig, ServiceContentConfig, ServicePlansConfig, ServiceBookingConfig } from "./types";
